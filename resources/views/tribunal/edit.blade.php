...
<div class="container">
			...
			<form action="{{ url('tribunals/'.$tribunal->id)}}" method="post">
				...
				<div class="form-column col-md-8 type-move0">
					<div class="col">
						...
						<input type="text" class="form-control" value="{{$tribunal->nom_tribunal}}" name="nom_tribunal" style="margin-top: -50px;margin-left: 120px; width: 200px"> 
				...
				<div class="form-column type-move21">
					...
					<div class="col movedown">
						...
						<span class="span1"><input type="text" class="form-control" value="{{$tribunal->ville}}" name="ville" style="width: 160px;"></span>
                ...
                <div class="form-column type-move22">
					...
					<div class="col movedown">
						...
						<span class="span1"><input type="text" class="form-control" value="{{$tribunal->adresse}}" name="adresse" style="width: 160px;"></span>
  ...
  <select id="type" name="type" style="padding: 5 20 5 20">
    <option value="Premiere instance" {{($tribunal->type === 'Premiere instance') ? 'Selected' : ''}}>Premiere instance</option>
    <option value="Cour appel" {{($tribunal->type === 'Cour appel') ? 'Selected' : ''}}>Cour d'appel</option>
    <option value="Cour de cassation" {{($tribunal->type === 'Cour de cassation') ? 'Selected' : ''}}>Cour de cassation</option>
