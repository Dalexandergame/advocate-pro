    ...
    <div class="modal-content" style="width: 796px; height: 800px; margin-left: 400px;">
        ...
        <div class="add-form">
          ...
          <div class="form-back">
            ...
            <br>
            <input class="f-input" type="text" id="title" name="titre" style="height: 28px;" value="{{$mission['titre']}}">
            <br><br>
            ...
            <br><br>
            <label  class="f-label" for="datecreation"><p class="tmpMission"><img src="{{ url('img/debutMission.svg') }}">{{$mission->datecreation->format('F j Y')}}(Date de debut de mission)</p></label>
            <br>
            <label class="f-label" for="dateecheance">Date d’échéance</label>
            <br>
            <input class="f-input" type="text" id="dateecheance" name="dateecheance" onfocus="(this.type='date')" style="height: 28px;width: 200px;" value="{{$mission['dateecheance']->format('jFY')}}">
            <br><br>
