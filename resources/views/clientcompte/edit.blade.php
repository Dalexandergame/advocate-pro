			...
			<form action="{{ url('clientcomptes/'.$clientcompte->id)}}" method="post">
				...
				<div class="form-column col-md-8 type-move0">
					<div class="col">
						...
						<input type="text" class="form-control" placeholder="Entreprise Nom" name="nom_entreprise" value="{{ $clientcompte->nom_entreprise }}" style="margin-top: -50px;margin-left: 120px; width: 250px"> 
						<div style="margin-top: 5px"></div>
						<div class="nbrdossier"> {{$clientcompte->dossier_lier}} </div>
					</div><div style="margin-top: 5px"></div>
					<div class="col" >
						<label class="addressdeplacement">Adresse</label>
						<input type="text" class="form-control" placeholder="tapez votre adresse ici..." name="adresse" value="{{$clientcompte->adresse}}" style="border: none; border-color: transparent; outline: none; margin-left: 110px;">
					</div>
					<div class="col">
						<input type="text" class="form-control" placeholder="tagwords" name="tagwords" value="{{$clientcompte->tagwords}}" style="margin-left: 120px; margin-top: 50px;width: 250px;">
					</div>
				</div>
				
				<div class="form-column type-move21">
					<div class="col" >
						<input type="text" class="form-control" placeholder="Nom de contact 01" name="nom_contact" value="{{$clientcompte->nom_contact}}" style="border: none; border-color: transparent; outline: none; font-weight: bold;">
					</div>
					<div class="col">
						<label for="" style="float: left; font-weight: bold;padding-top: 12px;">Tél</label>
						<span class="span1"><input type="text" class="form-control" placeholder="Tapez votre numero" name="tel_contact" value="{{$clientcompte->tel_contact}}" style="border: none; border-color: transparent; outline: none;width: 160px;"></span>
						
					</div>
					<div class="col">
						<label for="" style="float: left; font-weight: bold;padding-top: 12px;">Mail</label>
						<span class="span1"><input type="text" class="form-control" placeholder="Tapez votre email" name="mail_contact" value="{{$clientcompte->mail_contact}}" style="border: none; border-color: transparent; outline: none;width: 160px;"></span>
                ...
                <div class="form-column type-move22">
					<div class="col" >
						<input type="text" class="form-control" placeholder="contact principal" name="nom_contact_principal" value="{{$clientcompte->nom_contact_principal}}" style="border: none; border-color: transparent; outline: none; font-weight: bold;">
					</div>
					<div class="col">
						<label for="" style="float: left; font-weight: bold;padding-top: 12px;">Tél</label>
						<span class="span1"><input type="text" class="form-control" placeholder="Tapez votre numero" name="tel_contact_principal" value="{{$clientcompte->tel_contact_principal}}" style="border: none; border-color: transparent; outline: none;width: 160px;"></span>
						
					</div>
					<div class="col">
						<label for="" style="float: left; font-weight: bold;padding-top: 12px;">Mail</label>
						<span class="span1"><input type="text" class="form-control" placeholder="Tapez votre email" name="mail_contact_principal" value="{{$clientcompte->mail_contact_principal}}" style="border: none; border-color: transparent; outline: none;width: 160px;"></span>
				...
				<div class="form-column type-move23">
					...
					<div class="col">
						<span class="span1"><input type="text" class="form-control" placeholder="numero du dossier" name="dossier_lier" value="{{$clientcompte->dossier_lier}}" style="border: none; border-color: transparent; outline: none;width: 160px;"></span>	
					</div>
				</div>
