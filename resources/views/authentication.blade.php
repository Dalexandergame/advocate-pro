...
<body>
    ...
    <div id="auth" class="row no-gutters">
        <div id="msg" class="col-md-6">
          <H1>"La gloire d'un bon avocat consiste à gagner de mauvais procès."</H1>
  ...
  <div class="mb-4 form-check">
    ...
    <label class="form-check-label" for="exampleCheck1" id="rem">Me souvenir de moi</label>
  </div>
  <button type="button" class="btn btn-dark">Connecter</button>
</form>
        </div>
    </div>
