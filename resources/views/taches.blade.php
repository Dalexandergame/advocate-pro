    ...
    <div class="modal-content" style="width: 663px;height: 820px;">
        <div class="modal-body">
          ...
          <form action="{{ url('taches') }}" method="POST">
            ...
            <br>
            <input class="f-input px-2" type="text" name="dateecheance" placeholder="Date d’échéance de la tâche" onfocus="(this.type='datetime-local')" style="height: 28px;width: 180;">
            </div>
            <div id="audiance_input" style="display:none;">
            <label class="f-label" for="dateecheance">Date & Heure d’Audience</label>
            <br>
            <input class="f-input px-2" type="text" name="dateaudiance" placeholder="Date de la Prochaine Audience" onfocus="(this.type='datetime-local')" style="height: 28px;width: 180;">
            <br><br>
            <label class="f-label" for="file_number">Numero du Dossier Juridique</label>
            <br>
            <input class="f-input px-2" type="text" name="file_number" placeholder="Saisir le Numero du Dossier" style="height: 28px;width: 180;">
            <br><br>
            <label class="f-label" for="tribunal_number">Numero du Tribunal</label>
            <br>
            <input class="f-input px-2" type="text" name="tribunal_number" placeholder="Saisir le Numero du Tribunal" style="height: 28px;width: 180;">
            </div>
            ...
            <br>
            <input class="f-input px-2" type="text" name="titre" placeholder="Tapez Votre Titre Ici ..." style="height: 43px;width: 550px;"  required>
            <br><br>
            <label  class="f-label" for="description">Description de la Tâche</label>
            <br>
            <textarea class="f-input px-2" type="text"  name="description" placeholder="Tapez Votre Texte Ici ..." style="height: 135px;width: 550px;" required></textarea>
            ...
            <nav class="navbar navbar-expand-lg navbar-light" id="tnav">
                <div class="container-fluid p-0" id="tmenu">
                    <div class="navbar-nav sm-menu">
                        ...
                        <a class="nav-link px-md-4" href="{{ url('/taches/audiances') }}">Mes Audiences <span style="color: #989898;">( {{ $data7 }} )</span></a>
                    </div>
                </div>
            </nav>
    </div>
...
<div class="d-flex justify-content-between">
                <div class="mx-auto" style="width: 272px;height: 226px;">
                    ...
                    <div class="tl-wrapper row pl-2">
                    <div class="col title">
                    <div style="margin-top: 15px;">Ouvert <span style="color: #989898;">{{ $data1 }}</span><hr color="red"></div>
                    </div>
                    </div>
                    </div>
                    <!--taches ouvert-->
                          ...
                          <div style="margin-right:20px;">
                           ...
                           <br>
                             <div>
                                ...
                                <br>
                                <button class="button0 button4" style="margin-left: 20px;" onclick="window.location.href='{{ url('./taches-details', $tache->id) }}'">Ouvert</button>
                              </div>
                        </div>
                   @endforeach
                </div>
                           ...
                           <br>
                             <div>
                                ...
                                <p class="tdate">Debut de la Tâche {{ $tache['created_at']->format('d/m/Y') }}
                                    <br>
                                <span style="color: #ED741C;">Fin de Tâche {{ $tache['dateecheance']->format('d/m/Y') }}</span>
                                </p>
                                <br>
                                <br>
                                <h5>{{ $tache['titre'] }}</h5>
                        ...
                        <div class="shadow py-3 my-3 tasks">
                           ...
                           <br>
                             <div>
                                ...
                                <p class="tdate">Debut de la Tâche {{ $tache['created_at']->format('d/m/Y') }}
                                    <br>
                                <span style="color: #3AE341;">Fin de Tâche {{ $tache['dateecheance']->format('d/m/Y') }}</span>
                                </p>
                                <br>
                                <br>
                                <h5>{{ $tache['titre'] }}</h5>
                        ...
                        <div class="shadow py-3 my-3 tasks">
                           ...
                           <br>
                             <div>
                                ...
                                <p class="tdate">Debut de la Tâche {{ $tache['created_at']->format('d/m/Y') }}
                                    <br>
                                <span style="color: #989898;">Fin de Tâche {{ $tache['dateecheance']->format('d/m/Y') }}</span>
                                </p>
                                <br>
                                <br>
                                <h5>{{ $tache['titre'] }}</h5>
