...
<div class="container bg-white p-4">
    <div class="row">
        <div class="col">
            <h5 class="font-weight-bold">Catégorie 1</h5>
            <span>Vignettes</span>
        </div>
        <div class="col">
    ...
    <div class="row mt-4 mx-4">
        ...
        <div class="col-md" style="background-color: #FAFAFA ; padding: 2.5rem">
            ...
            <span class="text-danger"><img class="mr-1" src="img/alarm.png"/>100</span><br>
            <span class="">JJ.MM.YYYY</span>
        </div>
    </div>
    <div class="row mt-4">
        <div class="col-md offset-8">
            <div>
                <a href="/ajouter-cat-produit" class="btn btn-dark px-4">
                    <img class="mr-1" src="img/stock.svg"/>
