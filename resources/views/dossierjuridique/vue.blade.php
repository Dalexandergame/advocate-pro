...
<div class="container">
	<div class="big-grid">
		<div class="row" style="margin-top: 20px">
			...
			<div class="w-100"></div>
			<div class="col-2.5 marg-c1 bold-description-kech">Marrakech le({{ $dossierjuridique->date_creation }})</div>
	...
	<div class="float-child" style="margin-left: 300px; width: 1160px">
		...
		<div class="row">
			...
			<div class="buttons-position-3"> 
				<button class="buttonx2" class="btn btn-default btn-lg" onclick="window.location='{{ url('/dossierjuridiques') }}'"><img src="/img/hide-eye.png" height="16px" width="15px"  style="margin-right: 2px; margin-top: -2px"/> Masquer</button>
