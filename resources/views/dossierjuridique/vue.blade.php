...
<div class="float-container">
	<div class="float-child">
		<div class="big-grid2">
			<div class="row">
				<div class="col-2.5"> 
					<img src="{{ url('/img/profile.png')}}" height="38px" width="38px" style="margin-left: 40px;margin-top: 20px"/> <div class="marg-responsable-dossier"><div class="gray-bold">Responsable du dossier</div><br><div class="gray-normal">Nom & Prénom</div></div>
		...
		<div class="big-grid2">
			<div class="row">
				<div class="col-2.5">
					...
					<img src="{{ url('/img/profile.png')}}" height="38px" width="38px" style="margin-left: 40px;margin-top: 20px"/> <div class="marg-responsable-dossier"><div class="gray-bold">Utilisateur en charge</div><br><div class="gray-normal">{{ $lasttache->name }}</div></div><br>
    ...
    <div class="modal-content" style="width: 870px;height: 1020px;">
        <div class="modal-body">
          ...
          {{-- <form action="{{ url('') }}" method="POST">
            ...
            <span class="numberd" style="margin-left:30px;">Dossier N° </span><input class="f-input numberd" type="text" name="file_number" value="{{ $lasttache->file_number }}">
                  ...
                  <table border="1" cellspacing="0" cellpadding="4" class="tab" style="margin-left:5px;">
                    ...
                    <tbody> 
                      <tr>
                        ...
                        <td rowspan="2" class="tab-input">{{ $audiance['for'] }}<br><span style="font-weight: bold;">Contre</span><br>{{ $audiance['against'] }}</td>
...
{{-- 
             ...
             <div style="display:inline-block;">
                ...
                @endforeach
					...
					<img src="{{ url('/img/profile.png')}}" height="30px" width="30px" style="margin-left: 40px;margin-top: 20px"/> <div class="marg-responsable-dossier"><div class="gray-normal2">{{ $lasttache->comment }}</div><br>

					

					<a type="button" data-toggle="modal" data-target="#Modalcomments" class="a-afficher"><div class="gray-bold-rep">

						<img src="{{ url('/img/attach.png')}}" height="11px" width="11px" style="margin-left: 50px;"/><div class="colored-gray-joint">{{ $lasttache->file }}</div><br>Afficher les réponses </div><div class="gray-number">{{-- (14) --}}</div></div></a>
...
@endforeach
                ...
                <form method="post" action="{{ route('comment.add') }}" enctype="multipart/form-data">
			        ...
			        <div class="form-inline" style="margin-left:50px;">
			            <input type="hidden" name="tache_id" value="{{ $lasttache->id }}" />
			            <input type="text" class="comment" name="comment" placeholder="Ajouter une reponse" required/>
			            <input type="file" name="file" id="file" class="inputfile" multiple onchange="javascript:updateList()"  />
			            <label for="file" id="fileList">+ Ajouter piece jointe </label>
					...
					<a class="marg-circle-button"type="button" data-toggle="modal" data-target="#Modaladd"><div class="circle">+</div><div class="gray-bold-rep2">Assigner une tâche</div></a>
 <!-- Add Tache Modal -->
        ...
        <div class="modal-body">
          ...
          <button class="buttone" class="btn btn-default btn-lg"> Enregister</button>
				...
				<div class="col-2.5">
					...
					<div style="margin-left: 335px;margin-top: 190px"><a href="" class="a-afficher"><img src="{{-- {{ url('/img/attach.png')}} --}}" height="11px" width="11px" style="margin-left: 50px;"/>  <div class="colored-gray-joint">{{-- {{ $lasttache->file }} --}}</div></a></div>
				</div>
			</div>
		</div>
	</div>
...
<div class="float-container">
	<div class="float-child" style="margin-left: 400px; width: 1160px">
		<div class="big-grid2" >
			...
			<div class="w-100"></div>
			<div class="col-2.5 marg-c1-date bold-description1"style="margin-left:150px;"> {{ $dossierjuridique->tribunal_number }}</div>
		</div>
		<div class="row">
		...
		<div class="row">
			...
			<div class="buttons-position-3"> 
				...
				<button style="margin-left: 10px" class="buttonw2" class="btn btn-default btn-lg"><img src="{{ url('/img/folder.png')}}" height="14px" width="14px" style="margin-right: 2px; margin-top: -2px" /> Créer un sous dossier</button>
